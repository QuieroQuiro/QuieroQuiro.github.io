...
export default function Login() {
    ...
    const handleLogin = async (e: React.FormEvent) => {
        ...
        if (authError) {
            setError(authError.message === 'Invalid login credentials' ? 'Credenciales inválidas' : authError.message || 'Error al iniciar sesión');
        } else if (data) {
            // TODO: Redirigir según rol, por ahora enviamos al inicio o paciente
            navigate('/paciente');
        }
        setLoading(false);
    };
    ...
    return (
        <div className="flex flex-col flex-grow items-center justify-center p-4 py-12 md:py-24 animate-in fade-in duration-500">
            ...
            <div className="w-full max-w-md bg-background/80 backdrop-blur-xl border border-primary/20 p-8 rounded-3xl shadow-2xl relative overflow-hidden">
                <div className="absolute top-0 right-0 -mr-16 -mt-16 w-32 h-32 rounded-full bg-primary/10 blur-3xl shadow-[0_0_50px_rgba(var(--primary),0.5)]"></div>
                <div className="absolute bottom-0 left-0 -ml-16 -mb-16 w-32 h-32 rounded-full bg-primary/10 blur-3xl shadow-[0_0_50px_rgba(var(--primary),0.5)]"></div>

                <div className="text-center mb-8 relative z-10">
                    <h1 className="text-3xl font-bold tracking-tight text-foreground mb-2">Bienvenido de vuelta</h1>
                    <p className="text-foreground/60">Ingresa a tu cuenta para continuar</p>
                </div>
                ...
                <form onSubmit={handleLogin} className="space-y-5 relative z-10">
                    ...
                    <div className="space-y-1.5">
                        <div className="flex justify-between items-center ml-1">
                            ...
                            <a href="#" className="flex text-xs font-semibold text-primary hover:text-primary/80 transition-colors">
                ...
                <div className="relative my-8 z-10">
                    ...
                    <div className="relative flex justify-center text-sm">
                        <span className="px-4 text-foreground/50 bg-background/80">O continúa con</span>
                    </div>
                </div>
